...
export const WaterPage = () => {
    ...
    // 1. Cargar datos del servidor (Consumo real acumulado)
    ...
    const handleSaveWater = async () => {
        ...
        try {
            const res = await fetch(`${backendUrl}/api/daily-log/water`, {
                ...
                // Aseguramos que la llave sea exactamente "water" para el backend
                            ...
                            <div className="border rounded-4 p-4 bg-light mb-4 shadow-sm">
                                <div className="row text-center mb-4">
                                    <div className="col-6 border-end">
                                        ...
                                        {/* Este número ahora se actualizará tras el await loadData() */}
                                ...
                                <div className="mb-3">
                                    <div className="d-flex justify-content-between small fw-bold text-muted mb-1">
                                        ...
                                        <span className={totalPercentage >= 100 ? "text-success" : ""}>
